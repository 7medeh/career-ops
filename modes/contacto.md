...
2. **Classify the contact type** -- ask the candidate or infer it from context:
   - **Recruiter** -- someone whose role is talent acquisition, sourcing, or recruiting
   - **Hiring Manager** -- the person leading the team that is hiring
...
3. **Pick the primary target**: the person who would benefit most from having the candidate there
...
4. **Generate the message** using a 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: A detail that answers their screening questions before they ask (e.g. "5 years building ML pipelines, currently in Berlin, available immediately")
   ...
   - **Sentence 2 (Proof)**: The candidate's biggest quantifiable win showing they've solved similar problems
   ...
   - **Sentence 1 (Research)**: A reference to something specific in their work or background
   ...
   - **Note**: Keep the tone light, not desperate. The goal is for them to know you prepared.

5. **Versions**:
   - EN (default)
   - Local language (if the company is not English-speaking)
