...
For each offer: score every dimension, then compute the total weighted score.
Final ranking + recommendation, factoring in time-to-offer considerations.

Ask the user for the offers if they aren't already in context. They can be text, URLs, or references to offers already evaluated in the tracker.
