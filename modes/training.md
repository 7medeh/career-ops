...
For each course or certification the candidate asks about, evaluate 6 dimensions:

| Dimension | What it measures |
|-----------|------------------|
| North Star alignment | Does it move you toward or away from the goal? |
...
- **DON'T DO IT** → a better alternative, with justification
