...
func LoadContacts(careerOpsPath string) map[string][]model.Contact {
	out := make(map[string][]model.Contact)
...
func ContactsFor(contacts map[string][]model.Contact, company string) []model.Contact {
